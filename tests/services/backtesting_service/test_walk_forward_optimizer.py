...
from services.backtesting_service.optimization.walk_forward_optimizer import (
    WalkForwardOptimizer, get_walk_forward_optimizer
)
...
class TestWalkForwardGlobalFunctions:
    ...
    def test_get_walk_forward_optimizer_singleton(self):
        ...
        import services.backtesting_service.optimization.walk_forward_optimizer as wf_opt
        wf_opt.walk_forward_optimizer = None
...
class TestWalkForwardIntegration:
    ...
    @patch('services.backtesting_service.optimization.walk_forward_optimizer.WalkForwardOptimizer._evaluate_parameters')
