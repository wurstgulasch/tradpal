...
from services.data_service.data_fetcher import AdaptiveRateLimiter
...
class TestAdaptiveRateLimiter:
    ...
    @patch('time.sleep')
    @patch('services.data_service.data_fetcher.AdaptiveRateLimiter.can_make_request')
    @patch('services.data_service.data_fetcher.AdaptiveRateLimiter.record_request')
    def test_adaptive_retry_decorator_success(self, mock_record, mock_can_make, mock_sleep):
        ...
        from services.data_service.data_fetcher import adaptive_retry
    ...
    @patch('services.data_service.data_fetcher.AdaptiveRateLimiter.can_make_request')
    @patch('services.data_service.data_fetcher.AdaptiveRateLimiter.record_request')
    @patch('services.data_service.data_fetcher.AdaptiveRateLimiter.record_error')
