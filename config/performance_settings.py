...
MEMORY_MAPPED_DATA_ENABLED = MEMORY_MAPPED_ENABLED
CHUNK_SIZE = CHUNK_SIZE_DEFAULT
CACHE_ENABLED = CACHE_ENABLED
CACHE_TTL = CACHE_TTL_DEFAULT
ASYNC_PROCESSING_ENABLED = ASYNC_IO_ENABLED
...
REDIS_TTL_INDICATORS = CACHE_TTL_DEFAULT
REDIS_TTL_API = CACHE_TTL_DEFAULT
REDIS_MAX_CONNECTIONS = REDIS_CACHE_POOL_SIZE